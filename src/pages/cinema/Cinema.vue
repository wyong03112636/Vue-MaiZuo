  ...
  <div class="wrap-cinema">
      <div class="wrap-main" >
        ...
        <section class="jqk" v-show="isShow">
          ...
          <nav>
            <b v-for="(area,index) in area_list" 
            :key="area.id" 
          ...
          <article>
            <b v-for="subarea in sub_area"
              :key="subarea.id"
              @click="handleSubArea(subarea.id)"
            >{{subarea.name}}</b>
          </article>
        </section>
      <section id="scroll">
         ...
         <div class="list-content" v-else>
          <div class="cinema-list" v-for="item in cinema_list" :key="item.id" @click="handleClick(item.id)" >
            <div class="left" >
              <h3>{{item.nm}}</h3>
              <p>{{item.addr}}</p>
            </div>
